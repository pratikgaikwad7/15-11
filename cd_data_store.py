...
TABLE_CONFIGS = {
    ...
    'jta': {
        'columns': [
            'sr_no', 'ticket_no', 'name', 'gender', 'employee_category', 'status', 
            'joining_year', 'date_of_joining', 'jta_batch_number', 'date_of_separation', 
            'trade', 'final_result', 'training_name'
        ],
        'required_columns': ['ticket_no', 'name'],
    ...
    'ta': {
        'columns': [
            'sr_no', 'ticket_no', 'name', 'gender', 'employee_category', 'status', 
            'joining_year', 'date_of_joining', 'ta_batch_number', 'date_of_separation', 
            'trade', 'final_result', 'training_name'
        ],
        'required_columns': ['ticket_no', 'name'],
        'display_name': 'TA Data'
    },
    'kaushalya': {
        'columns': [
            'sr_no', 'ticket_no', 'name', 'gender', 'joining_year', 'date_of_joining',
            'kaushalya_batch_no', 'trade', 'dei_batch', 'sem_1_pass_fail', 'sem_2_pass_fail',
            'sem_3_pass_fail', 'sem_4_pass_fail', 'sem_5_pass_fail', 'sem_6_pass_fail',
            'final_result', 'placement_drive', 'training_name', 'remark'
        ],
        'required_columns': ['ticket_no', 'name', 'date_of_joining'],
    ...
    'lakshya': {
        'columns': [
            'sr_no', 'ticket_no', 'name', 'gender', 'course_joining_year', 
            'date_of_joining', 'date_of_separation', 'lakshya_batch_no', 
            'diploma_name', 'diploma_trainee_inplant_shop', 'semester_1_pass_fail', 
            'semester_2_pass_fail', 'second_year_pass_fail', 'third_year_pass_fail', 
            'fourth_year_pass_fail', 'final_result', 'training_name', 'remark'
        ],
        'required_columns': ['ticket_no', 'name', 'date_of_joining'],
    ...
    'live_trainer': {
        'columns': [
            'sr_no', 'faculty_name', 'ticket_no', 'mail_id', 'mobile_number', 
            'area', 'dept', 'factory', 'reporting_manager_name', 
            'reporting_manager_mail_id', 'expertise_area', 'expertise_category', 
            'hr_coordinator_name', 'remark'
        ],
        'required_columns': ['faculty_name', 'ticket_no'],
...
COLUMN_MAPPING = {
    ...
    # TA specific mappings
    'ta batch number': 'ta_batch_number',
    'ta_batch_number': 'ta_batch_number',
    # Kaushalya specific mappings
    'kaushalya batch no.': 'kaushalya_batch_no',
    'kaushalya batch no': 'kaushalya_batch_no',
    'dei batch(y/n)': 'dei_batch',
    'dei batch': 'dei_batch',
    'sem 1 pass/fail': 'sem_1_pass_fail',
    'sem 2 pass/fail': 'sem_2_pass_fail',
    'sem 3 pass/fail': 'sem_3_pass_fail',
    'sem 4 pass/fail': 'sem_4_pass_fail',
    'sem 5 pass/fail': 'sem_5_pass_fail',
    'sem 6 pass/fail': 'sem_6_pass_fail',
    'placement drive': 'placement_drive',
    # Lakshya specific mappings
    'lakshya batch no.': 'lakshya_batch_no',
    'diploma trainee inplant shop': 'diploma_trainee_inplant_shop',
    'semester 1 pass/fail': 'semester_1_pass_fail',
    'semester 2 pass/fail': 'semester_2_pass_fail',
    'second year pass/fail': 'second_year_pass_fail',
    'third year pass/fail': 'third_year_pass_fail',
    'fourth year pass/fail': 'fourth_year_pass_fail',
    # Live Trainer specific mappings
    'faculty name': 'faculty_name',
    'mail id': 'mail_id',
    ...
    'manager name': 'reporting_manager_name',
    'reporting manager mail id': 'reporting_manager_mail_id',
    'manager mail id': 'reporting_manager_mail_id',
    'manager email': 'reporting_manager_mail_id',
    'expertise area': 'expertise_area',  # Fixed typo: was 'experties area'
    'area of expertise': 'expertise_area',
    'specialization': 'expertise_area',
    'expertise category': 'expertise_category',  # Fixed typo: was 'experties category'
    'category': 'expertise_category',
    'hr coordinator name': 'hr_coordinator_name',
    'hr coordinators name': 'hr_coordinator_name',
    'hr coordinator': 'hr_coordinator_name',
...
REPLACE_TABLES = ['induction', 'fta', 'jta', 'ta', 'kaushalya', 'pragati', 'lakshya', 'live_trainer', 'fst']
...
def process_data(df, table_config):
    ...
    # Additional debug for kaushalya table
    if table_config.get('display_name') == 'Kaushalya Data':
        print("Kaushalya specific debugging:")
        print("Excel columns found:", df.columns.tolist())
        print("Looking for these mappings:")
        for col in ['kaushalya_batch_no', 'dei_batch', 'sem_1_pass_fail', 'sem_2_pass_fail', 
                    'sem_3_pass_fail', 'sem_4_pass_fail', 'sem_5_pass_fail', 'sem_6_pass_fail',
                    'placement_drive']:
            print(f"- {col}: mapped from {[k for k, v in normalized_mapping.items() if v == col]}")
